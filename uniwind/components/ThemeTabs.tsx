...
import { View, ScrollView, Animated, Dimensions, TouchableOpacity, ViewStyle, Platform } from 'react-native';
            ...
            >
                ...
                <View className="z-10">
                    {type === 'scrollview' ? (
                        ...
                        <View style={style} className={`flex-row h-[48px] border-b border-border ${classNameBg}`}>
                            {tabs.map((tab, index) => {
                                if (!React.isValidElement(tab)) return null;
                                return (
                                    <Animated.View
