...
export const BalanceChart = () => {
    ...
    const colors = useThemeColors();
        ...
        const followersData = [
      1.2, 1.3, 1.4, 1.5, 1.6, 1.8, 2.1, 2.4, 2.7, 3.2,
      3.6, 4.1, 4.5, 4.8, 5.2, 5.7, 6.1, 6.8, 7.3, 7.9,
    ];


    const currentFollowers = followersData[followersData.length - 1];
    const startingFollowers = followersData[0];
    const followersGained = currentFollowers - startingFollowers;
