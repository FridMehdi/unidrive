  ...
  return (
    <>
      ...
      <ActionSheetThemed
        ...
        gestureEnabled
      >
        <View className="pt-6 px-10 pb-6 items-center justify-center flex-col">
          <Icon name="Bookmark" size={24} color="white" className='w-20 h-20 bg-highlight rounded-full items-center justify-center' />
